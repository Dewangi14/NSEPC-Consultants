...
const MissionVision = React.forwardRef((props, ref) => {
  ...
  return (
    <div ref={ref} 
    data-text={"Mission. At NSEPC Consultants India Private Limited, our mission is to transform India’s ethanol and renewable energy landscape through end-to-end Engineering, Procurement, and Construction (EPC) solutions. With over 18 years of expertise, we deliver turnkey projects that prioritize operational excellence, sustainability, and regulatory compliance."}
