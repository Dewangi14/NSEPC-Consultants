      ...
      <div className="relative flex flex-col gap-5 w-full lg:w-7/12 py-10 md:py-16 xl:py-20 px-10 md:px-16 xl:px-20 bg-[#061833] text-white text-right">
        ...
        <div className="w-full flex flex-row-reverse">
          <div className="font-light text-sm sm:text-base xl:text-lg w-full lg:w-2/3 flex flex-row-reverse leading-relaxed">
            <FadeInFromRight>
              At NSEPC India Pvt. Ltd., our vision is to be a trusted global EPC
              partner in ethanol and biofuel infrastructure development. We
              aspire to create large-scale, future-ready facilities that drive
              sustainable growth, technological excellence, and long-term value
              for our clients across energy-driven industries.
            </FadeInFromRight>
          </div>
        </div>
        ...
        <div className="absolute -left-28 top-10 xl:top-12 hidden lg:block">
          <FadeInFromLeft duration={0.4}>
            <div className="relative w-72 h-72 xl:w-80 xl:h-80 rounded-md image-shadow">
              <Image
